function varargout = TopoMaker(varargin)
% TOPOMAKER MATLAB code for TopoMaker.fig
%      TOPOMAKER, by itself, creates a new TOPOMAKER or raises the existing
%      singleton*.
%
%      H = TOPOMAKER returns the handle to a new TOPOMAKER or the handle to
%      the existing singleton*.
%
%      TOPOMAKER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TOPOMAKER.M with the given input arguments.
%
%      TOPOMAKER('Property','Value',...) creates a new TOPOMAKER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TopoMaker_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TopoMaker_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TopoMaker

% Last Modified by GUIDE v2.5 26-Jul-2019 18:44:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TopoMaker_OpeningFcn, ...
                   'gui_OutputFcn',  @TopoMaker_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TopoMaker is made visible.
function TopoMaker_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TopoMaker (see VARARGIN)

% Choose default command line output for TopoMaker
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TopoMaker wait for user response (see UIRESUME)
...
function varargout = TopoMaker_OutputFcn(hObject, eventdata, handles) 
